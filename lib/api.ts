...
export const api  = {
  users: {
    getll: () => fetchHandler(`${API_BASE_URL}/users`),
    ...
    update: (id: string, userData: any) => fetchHandler(`${API_BASE_URL}/users/${id}`, {
      method: "PUT",
      body: JSON.stringify(userData),
    }),
  ...
  accounts: {
    getll: () => fetchHandler(`${API_BASE_URL}/accounts`),
    ...
    update: (id: string, accountData: any) => fetchHandler(`${API_BASE_URL}/accounts/${id}`, {
      method: "PUT",
      body: JSON.stringify(accountData),
    }),
